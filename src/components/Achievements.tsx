...
import awardImage from "../assets/7d030419-80e6-4fba-b268-f8042bdb6cee.JPG"
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Our Portfolio ICX Trailblazers 25.26 won the prestigious Impact & Innovation Award in ICX, marking a historic milestone for AIESEC in GIKI.
                </p>
