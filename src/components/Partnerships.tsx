  ...
  const partnerships = [
    {
      ...
      category: "Education",
      route: "mou-shah",
      bookletUrl: "https://drive.google.com/file/d/12dNbvsfdQZPtILiDwe3paPGfoRnMyZkG/view?usp=share_link",
      opportunityUrl: "https://expa.aiesec.org/opportunities/1331207"
    },
    {
      name: "Plush Natural",
      type: "IGT",
      ...
      bookletUrl: "https://drive.google.com/file/d/1t-6WUq_V132_SE4YwZeEU4jtupXYIKkn/view?usp=share_link",
      opportunityUrl: "https://aiesec.org/opportunity/global-talent/1331934"
    },
    {
      name: "Saba Trust",
      type: "IGV",
      ...
      category: "NGO",
      route: "mou-sabatrust",
      bookletUrl: "https://drive.google.com/file/d/1dcVw-_JUpFE8K_fYH4OSAf-CEUT7WeJE/view?usp=share_link",
      opportunityUrl: "https://aiesec.org/opportunity/global-volunteer/1336201"
    }
  ]
        ...
        <Card className="mt-8 p-8 bg-white border-2 border-blue-100">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              ...
              <div className="bg-gradient-to-br from-green-600 to-green-700 text-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 flex flex-col justify-between">
                <div>
                  <div className="flex items-center mb-4">
